namespace CustomBA
{
    ...
    public class UpdateViewModel : PropertyNotifyBase
    {
        ...
        {
            WixBA.Model.Engine.Log(LogLevel.Verbose, $"DetectUpdateBegin: UpdateLocation= {e.UpdateLocation}, Result = {e.HResult}");
        ...
        private void DetectUpdate(object sender, DetectUpdateEventArgs e)
        {
            ...
            WixBA.Model.Engine.Log(LogLevel.Verbose, $"DetectUpdate: UpdateLocation= {e.UpdateLocation}, Result = {e.HResult}");
            ...
            else if (e.Version <= WixBA.Model.Version)
            {
                ...
                e.HResult =(int) Result.Cancel;
            }
        }

        private void DetectUpdateComplete(object sender, DetectUpdateCompleteEventArgs e)
        {
            WixBA.Model.Engine.Log(LogLevel.Verbose, $"DetectUpdateComplete");
