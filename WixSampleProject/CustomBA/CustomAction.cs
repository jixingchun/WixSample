...
namespace CustomBA
{
    public class CustomAction
    {
        ...
        //        WriteLog( "DIAView:SourceDir:" + SourceDir);
        //        WriteLog( "DIAView:SQLdirpath:" + SQLdirpath);
        //        WriteLog( "DIAView:SQLfilePath:" + SQLfilePath);
        //        WriteLog( "DIAView:SQLfilePath:Argument" + args);
        ...
        //    catch (Exception ex)
        //    {
        //        WriteLog( $"Error happen in installing sql server express , {ex}");
